...
import { GraduationCap, ShieldCheck, BookOpen, PieChart, Check, ArrowRight } from 'lucide-react';
  ...
  const features = [
    {
      ...
      desc: "Alterne entre várias escolas na mesma conta. Os dados são blindados, garantindo isolamento total entre unidades fabris ou escolares."
    },
    {
      icon: BookOpen,
      title: "Gestão Acadêmica",
      desc: "Enturmação rápida, geração de Atas e Termos em PDF e controle total da vida escolar do aluno em poucos cliques."
    },
    {
      icon: PieChart,
      title: "RH & Financeiro",
      desc: "Gestão de contratos (Efetivos vs Designados), alertas de vencimento e painel financeiro detalhado para controle de caixa."
    }
  ];
        ...
        <div className="container">
          <div className="flex flex-col md:flex-row items-center gap-12">
            <div className="flex-1">
              <span className="text-brand-primary font-bold uppercase tracking-widest text-sm mb-4 block">Educação Inteligente</span>
              <h1 className="text-5xl md:text-6xl font-extrabold mb-8">EduGestão <span className="text-grad">Pro</span></h1>
              ...
              <Link to="/contato" className="grad-primary px-8 py-4 rounded-xl font-bold inline-flex items-center gap-2 hover:scale-105 transition-all text-white">
      ...
      <section className="py-32">
        <div className="container">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {features.map((f, i) => (
              <div key={i} className="glass p-10 rounded-3xl border-accent hover:border-brand-primary transition-all">
                <div className="w-14 h-14 bg-brand-primary rounded-2xl flex items-center justify-center mb-8 text-white">
                  <f.icon size={28} />
                </div>
